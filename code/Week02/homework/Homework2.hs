...
mkValidator _ MyRedeemer { flag1 = True, flag2 = False} _ = True
mkValidator _ MyRedeemer { flag1 = False, flag2 = True} _ = True
mkValidator _ MyRedeemer { flag1 = _, flag2 = _} _ = False
